<!-- Nhúng header -->
<header>
    <title>Đồng Hồ Cặp Đôi Tiếng Sét Ái Tình</title>
 </header>
<?php
...
?>
            ...
            <!-- Nội dung chính của trang đồng hồ nữ -->
             ...
             <div class="container-img">
                <div class="img-background">
                    <img src="/project/public/assets/image/DongHoCapDoi/backgroundcapdoi.webp" alt="">
                </div>
                <div class="img-con">
                <img src="/project/public/assets/image/DongHoCapDoi/logo.webp" alt="">
                </div>
            </div>
            ...
            <div class="breadcrumb-section container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Đồng Hồ Cặp Đôi</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row" id="filter-sort">
                <div class="col p-0">
                    <form action="index.php" method="GET">
                        <input type="hidden" name="url" value="donghocapdoi">
    ...
    <div class="product-container d-flex">
       ...
       <?php }}else{
        ...
        <!-- Nhúng footer -->
        <?php
        require_once __DIR__ . '/../../controllers/footer_controller.php';
        footer_controller::footer1();
        ?>
        <!-- Link trang js -->
