<!-- Nhúng header -->
<header>
    <title>Đồng Hồ Nam Cao Cấp Chính Hãng</title>
 </header>
<?php
        require_once __DIR__ . "/../footer/header1.php";
?>
        <main>
            <!-- Nội dung chính của trang đồng hồ nam -->
             <div class="container-donghonam">
             <div class="container-img">
                <div class="img-background">
                    <img src="/project/public/assets/image/DongHoNam/background.webp" alt="">
                </div>
                <div class="img-con">
                <img src="/project/public/assets/image/DongHoNam/dongholimited-edition-luxshopping1.png.webp" alt="">
                </div>
            </div>
            ...
            <div class="breadcrumb-section container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Đồng Hồ Nam</li>
                    </ol>
                </nav>
            </div>
        </div>
       ...
       <?php }}else{
        ...
        <!-- ---------------------------------------------------------------------------- -->
            <div id="search-top" class="search relative" style="transform: translateY(90%);">
            <div class="container">
